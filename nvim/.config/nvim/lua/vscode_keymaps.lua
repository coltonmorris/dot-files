...
-- keymap({'n', 'v'}, '<space>', "<cmd>lua require('vscode').action('whichkey.show')<CR>", { noremap = true, silent = true })


vim.opt.clipboard = "unnamed,unnamedplus" -- yanking adds to + and * registers. system clipboard is the * register btw.

-- Integrate with whichkey for spacemacs-style space key in normal + visual
vim.keymap.set({ 'n', 'v' }, '<space>', function()
  require('vscode').call('whichkey.show')
...
--
-- -- Normal-mode: <leader>a triggers VS Code’s “Find in Files”
