...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/colton.morris/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  ["material.nvim"] = {
    ...
    loaded = true,
    only_config = true,
    path = "/Users/colton.morris/.local/share/nvim/site/pack/packer/start/material.nvim",
