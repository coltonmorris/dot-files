...
_G.packer_plugins = {
  ...
  ["filetype.nvim"] = {
    ...
    loaded = true,
    path = "/Users/colton.morris/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = true,
    path = "/Users/colton.morris/.local/share/nvim/site/pack/packer/start/galaxyline.nvim",
